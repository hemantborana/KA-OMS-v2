...
const RevertIcon = () => <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 14 20 9 15 4"></polyline><path d="M4 20v-7a4 4 0 0 1 4-4h12"></path></svg>;

// --- TYPE & FIREBASE ---
interface Order { orderNumber: string; partyName: string; timestamp: string; deletedTimestamp?: string; deletionReason?: string; totalQuantity: number; totalValue: number; items: any[]; }
                ...
                {filteredOrders.map(order => (
                    <div key={order.orderNumber} style={styles.card}>
                        <div style={styles.cardHeader}>
                            ...
                            <button style={styles.revertButton} onClick={() => handleRevertOrder(order)}>
                                <RevertIcon /> Revert
                            </button>
                        </div>

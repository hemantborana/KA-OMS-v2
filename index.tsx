...
const NavIcon = ({ name, active = false }) => {
    ...
    const icons = {
        Dashboard: active ?
            <svg {...iconProps} fill="currentColor"><path d="M11.47 3.841a.75.75 0 0 1 1.06 0l8.69 8.69a.75.75 0 1 0 1.06-1.061l-8.689-8.69a2.25 2.25 0 0 0-3.182 0l-8.69 8.69a.75.75 0 1 0 1.061 1.06l8.69-8.689Z" /><path d="M12 5.432 20.159 13.59a2.29 2.29 0 0 1 .091.086v6.198A1.875 1.875 0 0 1 18.375 21H15a.75.75 0 0 1-.75-.75v-4.5a.75.75 0 0 0-.75-.75h-3a.75.75 0 0 0-.75.75V21a.75.75 0 0 1-.75-.75H5.625A1.875 1.875 0 0 1 3.75 19.375v-6.198a2.29 2.29 0 0 1 .091-.086L12 5.432Z" /></svg> :
            <svg {...iconProps} stroke="currentColor" fill="none" strokeWidth="1.5"><path d="M2.25 12L11.204 3.045a1.125 1.125 0 0 1 1.591 0L21.75 12M4.5 9.75v10.125A1.125 1.125 0 0 0 5.625 21H9.75v-4.875A1.125 1.125 0 0 1 10.875 15h2.25A1.125 1.125 0 0 1 14.25 16.125V21h4.125A1.125 1.125 0 0 0 19.5 19.875V9.75M8.25 21h8.25" strokeLinecap="round" strokeLinejoin="round" /></svg>,
        Entry: active ?
            <svg {...iconProps} fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M14 2H6C4.89 2 4 2.9 4 4V20C4 21.1 4.89 22 6 22H18C19.1 22 20 21.1 20 20V8L14 2ZM16 18H13V15H11V18H8V15H11V12H13V15H16V18ZM13 9V3.5L18.5 9H13Z" /></svg> :
            <svg {...iconProps} fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" /><line x1="12" y1="18" x2="12" y2="12" /><line x1="9" y1="15" x2="15" y2="15" /></svg>,
        Pending: active ?
            <svg {...iconProps} fill="currentColor"><path fillRule="evenodd" clipRule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25ZM12.75 6a.75.75 0 0 0-1.5 0v6c0 .414.336.75.75.75h4.5a.75.75 0 0 0 0-1.5h-3.75V6Z" /></svg> :
            <svg {...iconProps} fill="none" stroke="currentColor" strokeWidth="1.5"><path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg>,
        Stock: active ?
            <svg {...iconProps} fill="currentColor"><path d="M5.566 4.657A4.505 4.505 0 0 1 6.75 4.5h10.5c.41 0 .806.055 1.183.157A3 3 0 0 0 15.75 3h-7.5a3 3 0 0 0-2.684 1.657ZM2.25 12a3 3 0 0 1 3-3h13.5a3 3 0 0 1 3 3v6a3 3 0 0 1-3 3H5.25a3 3 0 0 1-3-3v-6ZM5.25 7.5c-.41 0-.806.055-1.184.157A3 3 0 0 1 6.75 6h10.5a3 3 0 0 1 2.683 1.657A4.505 4.505 0 0 0 18.75 7.5H5.25Z" /></svg> :
        ...
        Billing: <svg {...iconProps} fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>,
        Billed: <svg {...iconProps} fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="1" y="4" width="22" height="16" rx="2" ry="2"></rect><line x1="1" y1="10" x2="23" y2="10"></line></svg>,
        Update: <svg {...iconProps} fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg>,
        Inactive: <svg {...iconProps} fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path><line x1="15" y1="10" x2="9" y2="16"></line><line x1="9" y1="10" x2="15" y2="16"></line></svg>,
        Users: <svg {...iconProps} fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>,
        Approval: <svg {...iconProps} fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><polyline points="17 11 19 13 23 9"></polyline></svg>,
        Profile: active ?
            <svg {...iconProps} fill="currentColor"><path fillRule="evenodd" d="M7.5 6a4.5 4.5 0 1 1 9 0 4.5 4.5 0 0 1-9 0ZM3.751 20.105a8.25 8.25 0 0 1 16.498 0 .75.75 0 0 1-.437.695A18.683 18.683 0 0 1 12 22.5c-2.786 0-5.433-.608-7.812-1.7a.75.75 0 0 1-.437-.695Z" clipRule="evenodd" /></svg> :
            <svg {...iconProps} fill="none" stroke="currentColor" strokeWidth="1.5"><path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" /></svg>
    };
    ...
    return (
        <div style={{ ...styles.privacyPage, animation: isClosing ? 'slideOutRight 0.3s forwards' : 'slideInRight 0.3s forwards' }}>
            ...
            <div style={styles.privacyPageContent}>
                ...
                <p style={styles.privacyText}>
                    You have the right to access, update, or delete your personal information. You can manage your display name and avatar within the application's profile settings. For other requests, please contact the administrator.
                </p>
...
const Profile = ({ session, theme, toggleTheme, updateUserProfile, onLogout }) => {
...
const NavIconBottom = ({ name, active = false }) => {
    const iconStyle = { width: 24, height: 24 };

    const icons = {
        Home: {
            outline: (
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke="currentColor" fill="none" strokeWidth="1.5">
                    <path d="M2.25 12L11.204 3.045a1.125 1.125 0 0 1 1.591 0L21.75 12M4.5 9.75v10.125A1.125 1.125 0 0 0 5.625 21H9.75v-4.875A1.125 1.125 0 0 1 10.875 15h2.25A1.125 1.125 0 0 1 14.25 16.125V21h4.125A1.125 1.125 0 0 0 19.5 19.875V9.75M8.25 21h8.25" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
            ),
            filled: (
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M11.47 3.841a.75.75 0 0 1 1.06 0l8.69 8.69a.75.75 0 1 0 1.06-1.061l-8.689-8.69a2.25 2.25 0 0 0-3.182 0l-8.69 8.69a.75.75 0 1 0 1.061 1.06l8.69-8.689Z"/>
                    <path d="M12 5.432 20.159 13.59a2.29 2.29 0 0 1 .091.086v6.198A1.875 1.875 0 0 1 18.375 21H15a.75.75 0 0 1-.75-.75v-4.5a.75.75 0 0 0-.75-.75h-3a.75.75 0 0 0-.75.75V21a.75.75 0 0 1-.75-.75H5.625A1.875 1.875 0 0 1 3.75 19.375v-6.198a2.29 2.29 0 0 1 .091-.086L12 5.432Z"/>
                </svg>
            )
        },
        Stock: {
    ...
    return active ? React.cloneElement(iconSet.filled, { ...iconStyle }) : React.cloneElement(iconSet.outline, { ...iconStyle });
};
...
const BottomNavBar = ({ activeView, onNavigate }) => {
    ...
    useLayoutEffect(() => {
        const activeItemRef = itemRefs.current[activeView] || itemRefs.current['Dashboard'];

        if (activeItemRef && navRef.current) {
            setMarkerStyle({
                left: activeItemRef.offsetLeft + (activeItemRef.offsetWidth / 2) - (24 / 2),
                opacity: 1,
            });
        }
    }, [activeView]);
    ...
    return (
        <nav style={styles.bottomNav} ref={navRef}>
            <div style={{ ...styles.bottomNavMarker, ...markerStyle }} />
            {navItems.map(item => {
                ...
                return (
                    <a 
                        ...
                        style={navItemStyle}
                    >
                        <NavIconBottom name={item.label} active={isActive} />
    ...
    ({ activeView, onNavigate, session, isMobile, theme, toggleTheme, updateUserProfile, onLogout }, ref) => {
        ...
        if (isMobile) {
            ...
            if (activeView === 'Entry' || activeView === 'Pending') {
                ...
                mobilePadding = { padding: '0rem 0.25rem', paddingBottom: '85px' };
            }
            mainStyle = {
                ...styles.mainContent,
                ...mobilePadding,
        ...
        const renderView = () => {
            switch (activeView) {
                ...
                case 'Profile': return <Profile session={session} theme={theme} toggleTheme={toggleTheme} updateUserProfile={updateUserProfile} onLogout={onLogout} />;
...
// FIX: Added imageDb object to handle IndexedDB caching for images.
// This resolves the "Cannot find name 'imageDb'" error.
const imageDb = {
    db: null,
    init: function() {
    ...
    setImage: async function(key: string, blob: Blob, url: string) {
        const db = await this.init();
        return new Promise((resolve, reject) => {
            const transaction = db.transaction(['images'], 'readwrite');
            const store = transaction.objectStore('images');
            store.put({ key, blob, url });
            transaction.oncomplete = () => resolve(true);
            transaction.onerror = (event) => reject((event.target as IDBRequest).error);
        });
    },
    getImage: async function(key: string): Promise<{ key: string, blob: Blob, url: string } | undefined> {
        const db = await this.init();
        return new Promise((resolve, reject) => {
...
const KAOMSLogin = () => {
    ...
    const updateUserProfile = (newName, newAvatarId) => {
        ...
        fetch(SCRIPT_URL, {
            ...
            if (!result.success) {
                showToast('Failed to save profile to server.', 'error');
                // Revert to old session data if server fails
                setSession(oldSession);
                localStorage.setItem('ka-oms-session', JSON.stringify(oldSession));
            }
        }).catch(err => {
...
const styles: { [key: string]: React.CSSProperties } = {
    ...
    sidebarMobile: { position: 'fixed', top: 0, left: 0, height: '100%', zIndex: 200, width: '280px' },
